...
$secret = 'K/tDnHCcZaH7K+vnOgD3ZA==';//your app secret
$package = 'com.xiaomi.mipushdemo';//your app packagename
...
$targetMessage->setTarget('abcdefg', TargetedMessage::TARGET_TYPE_ALIAS); // 设置发送目标。可通过regID,alias和topic三种方式发送
...
$targetMessage2->setTarget('abcdefg', TargetedMessage::TARGET_TYPE_ALIAS);
